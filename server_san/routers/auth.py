# # Update in routers/auth.py to support login with email

# from fastapi import APIRouter, Depends, HTTPException, status, Response,HTTPException, BackgroundTasks, Request
# from fastapi.security import OAuth2PasswordRequestForm
# from datetime import timedelta
# import config
# from models.schema import UserCreate, User, Token
...
# # Add these models to your routes file:
...
#     return {"detail": "Token is valid", "email": token_data["email"]}
