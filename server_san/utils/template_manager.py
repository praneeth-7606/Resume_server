...
from .templete_4 import generate_resume_4,generate_cover_letter_4
from .templete_5 import generate_resume_5,generate_cover_letter_5
...
COVER_LETTER_TEMPLATES = {
    ...
    4: generate_cover_letter_4,
    5: generate_cover_letter_5    # Creative Portfolio template
    # Add more templates here when available
}
...
def get_available_templates() -> Dict[str, List[Dict[str, Any]]]:
    ...
    resume_templates = [
        ...
        {"id": 5, "name": "Academic Scholar", "description": "Refined template for academic and research positions"}
